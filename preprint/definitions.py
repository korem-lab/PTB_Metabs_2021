...
metabs_path = join(DATA_PATH, 'ST1.csv')
md_path = join(DATA_PATH, 'md.df')
elovitz_ct_path = join(DATA_PATH, 'mm_no_Thermodesulfatator_v3.rda')
mcs_path = join(DATA_PATH, 'ST2.csv')
NMPCs_path = join(DATA_PATH, 'ST7.csv') 
metabolite_annotations_path = join(DATA_PATH, "ST3.csv")
