...
def ext_data_figure_1():

	metabolites = get_metab_annotations()
	metabolites = metabolites[['Super pathway']]
	metabolites = metabolites.dropna()
	metabolomics = get_metabs(min_pres = 0, min_impute = False, named_only=False)
	...
	plt.tight_layout()
	plt.savefig(f"./figurePanels/ext_data_1A.png", dpi = 600, bbox_inches = 'tight')
	plt.savefig(f"./figurePanels/ext_data_1A.pdf", dpi = 600, bbox_inches = 'tight')
	...
	plt.tight_layout()
	plt.savefig(f"./figurePanels/ext_data_1B.png", dpi = 600, bbox_inches = 'tight')
	plt.savefig(f"./figurePanels/ext_data_1B.pdf", dpi = 600, bbox_inches = 'tight')
