...
def ext_data_fig_6B():
	...
	plt.savefig("./figurePanels/ext_data_6B.png", dpi=800, bbox_inches='tight')
	plt.savefig("./figurePanels/ext_data_6B.pdf", dpi=800, bbox_inches='tight')
...
def ext_data_fig_6C():
	...
	corrs_black.to_csv("microbe_metabolite_networks/ext_data_6C_edges.tsv", index=True, sep='\t')
...
def ext_data_fig_6D():
	...
	corrs_white.to_csv("microbe_metabolite_networks/ext_data_6D_edges.tsv", index=True, sep='\t')
...
def ext_data_fig_6E():
	...
	sig_corrs.to_csv("microbe_metabolite_networks/ext_data_6E_edges.tsv", sep='\t', index=True)
...
def ext_data_fig_6F():
	...
	plt.savefig("./figurePanels/ext_data_6F.pdf", dpi=600, bbox_inches='tight')
