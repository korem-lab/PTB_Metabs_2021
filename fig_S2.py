...
def figures_S2AB():
	...
	plt.savefig("figurePanels/S2A.png", dpi=800, bbox_inches='tight')
	plt.savefig("figurePanels/S2A.pdf", dpi=800, bbox_inches='tight')
	plt.figure(figsize=(8,4))
	plt.plot(list(range(1,kmax+1)), gaps, '-o')
	plt.xticks(list(range(1,kmax+1)))
	plt.savefig("figurePanels/S2B.png", dpi=800, bbox_inches='tight')
	plt.savefig("figurePanels/S2B.pdf", dpi=800, bbox_inches='tight')
...
def figure_S2C():
	...
	plt.ylabel("")
	plt.xlabel("")
	plt.savefig(f"./figurePanels/S2C.png", dpi=400, bbox_inches='tight')
	plt.savefig(f"./figurePanels/S2C.pdf", dpi=400, bbox_inches='tight')
	plt.close()
...
def figures_S2DEF():
	...
	plt.savefig("./figurePanels/S2D.pdf", dpi=800)
	...
	_=plt.yticks([])
	plt.legend([],[], frameon=False)
	plt.savefig("./figurePanels/S2E.pdf", dpi=800)
	...
	_=plt.yticks([])
	plt.legend([],[], frameon=False)
	plt.savefig("./figurePanels/S2F.pdf", dpi=800)
...
def figure_S2G():
	...
	md = get_md()
	mcs = get_mcs()
	metabs = get_metabs(min_impute=True, rzscore=True)
	...
	plt.savefig("./figurePanels/S2G.pdf", dpi=800, bbox_inches='tight')
