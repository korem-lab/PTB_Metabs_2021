...
def figure_S4A():
	...
	curr_metabs = ['diethanolamine', 'choline', 'ethyl beta-glucopyranoside', 
					'tartarate', 'X - 25656', 'glycerophosphoserine*', 
	...
	for m in curr_metabs:
		...
		plt.savefig(f"./figurePanels/S4A_{m}.pdf", dpi=800, bbox_inches='tight')
...
def figure_S4C():
	...
	make_heatmap(None, ['All', 'AA', 'White'], "all sPTB vs TB", "./figurePanels/S4C", 
		df=res, y_ticks=False, x_ticks=False, cbar_on=False, p_05_to_q=0.5)
	make_heatmap(None, ['All', 'AA', 'White'], "all sPTB vs TB", "./figurePanels/S4C_xticks", 
...
def figure_S4E():
	...
	plt.savefig("./figurePanels/S4E_diethanolamine.pdf", dpi=800, bbox_inches='tight')
	...
	plt.savefig("./figurePanels/S4E_ethyl_glucoside.pdf", dpi=800, bbox_inches='tight')
	...
	ax1.tick_params(axis='y', which='major', labelsize=14)
	ax2.tick_params(axis='y', which='major', labelsize=14)
	plt.savefig("./figurePanels/S4E_tartrate.pdf", dpi=800, bbox_inches='tight')
	...
	ax1.tick_params(axis='y', which='major', labelsize=14)
	ax2.tick_params(axis='y', which='major', labelsize=14)
	plt.savefig("./figurePanels/S4E_EDTA.pdf", dpi=800, bbox_inches='tight')
