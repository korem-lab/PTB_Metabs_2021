...
def figures_S3ABEFG():
	...
	plt.savefig(f"./figurePanels/S3A.png", dpi = 800, bbox_inches='tight')
	plt.savefig(f"./figurePanels/S3A.pdf", dpi = 800, bbox_inches='tight')
	...
	plt.subplots_adjust(hspace=0)
	plt.savefig(f"./figurePanels/S3B.png", dpi = 800, bbox_inches='tight')
	plt.savefig(f"./figurePanels/S3B.pdf", dpi = 800, bbox_inches='tight')
	...
	plt.savefig(f"./figurePanels/S3E.png", dpi = 800, bbox_inches='tight')
	plt.savefig(f"./figurePanels/S3E.pdf", dpi = 800, bbox_inches='tight')
	...
	plt.savefig(f"./figurePanels/S3F.png", dpi = 800, bbox_inches='tight')
	plt.savefig(f"./figurePanels/S3F.pdf", dpi = 800, bbox_inches='tight')
	...
	plt.savefig(f"./figurePanels/S3G.pdf", dpi = 800, bbox_inches='tight')
...
def figures_S3CD():
	...
	plt.savefig('./figurePanels/S3C.png', dpi = 800)
	plt.savefig('./figurePanels/S3C.pdf', dpi = 800)
	...
	_=plt.yticks([])
	plt.legend([],[], frameon=False)
	plt.savefig('./figurePanels/S3D.png', dpi = 800)
	plt.savefig('./figurePanels/S3D.pdf', dpi = 800)
