...
def ext_data_fig_7ABC():
	...
	plt.yticks([-1, 0, 1, 2])
	plt.savefig("figurePanels/ext_data_7A.pdf", dpi=800)
	...
	plt.yticks([-1, 0, 1, 2])
	plt.savefig("figurePanels/ext_data_7B.pdf", dpi=800)
	...
	plt.yticks([-1, 0, 1, 2])
	plt.savefig("figurePanels/ext_data_7C.pdf", dpi=800)
...
def ext_data_fig_7D():
	...
	plt.ylabel("")
	plt.xticks([], [])
	plt.savefig("figurePanels/ext_data_7D.pdf", dpi=800)
...
def ext_data_fig_7E():
	...
	plt.savefig("figurePanels/ext_data_7E.pdf", dpi=800, bbox_inches='tight')
